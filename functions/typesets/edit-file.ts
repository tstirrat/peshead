import { EditData } from '../shared/types/edit-file';
...
export const EditFile = {
  ...
  File: {
    ...
    players: [
      ...
      'Player',
      PLAYER_COUNT_MAX,
      (data: EditData) => data.header.playerCount
    ],
    teams: [
      ZeroPaddedArray,
      'Team',
      TEAM_COUNT_MAX,
      (data: EditData) => data.header.teamCount
    ],
    managers: [
      ZeroPaddedArray,
      'Manager',
      MANAGER_COUNT_MAX,
      (data: EditData) => data.header.managerCount
    ]
