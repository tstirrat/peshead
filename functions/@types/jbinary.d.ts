...
// Additional notes:
// Method stubs and types are taken from the official jBinary documentation,
...
declare module 'jbinary' {
  class jBinary {
    ...
    tell(): number;
    seek(position: number, callback?: (prop: jBinary, data: any) => any):
        number;
  ...
  // class Template {
  //   createProperty(binary: jBinary): any;
  //   setParams(): void;
  //   read(): any;
  //   baseRead(): any;
  //   baseWrite(value: any): any;
  //   write(value: any): any;
  // }
